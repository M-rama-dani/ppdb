   ...
   <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
     <div class="brand-logo">
      <a href="../admin.php">
       ...
       <h5 class="logo-text">selamt di gelombang
       </h5>
     </a>
   </div>
                      ...
                      ?>
                        <tbody style="background-color:black;">
                          ...
                          <td style="text-align: center;">
                            ...
                            <a title="hapus" class="btn btn-danger mdi mdi-delete" style="font-size: 10px;" href="proses/pros_hapus_gel.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">HAPUS</a>&nbsp;
                          </td>
                        </tbody>
                        <!-- Modal -->
