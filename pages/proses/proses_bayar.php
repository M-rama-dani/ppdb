...
$query_chek = "SELECT COUNT(*)as count FROM data_bayar WHERE no_pendaftaran = '$noPendaftaran'";
$result_check = mysqli_query($koneksi,$query_chek);
...
if($count > 0){
    ...
    $query = "INSERT INTO data_bayar (no_pendaftaran, tanggal,nama_siswa, asal_sekolah, gelombang, jumlah, bayar, kembalian,sisa, keterangan)
            VALUES ('$noPendaftaran', '$tanggal', '$namaSiswa', '$asal', '$gel', '$nominal', '$bayar', '$kembalian', ' $sisa', '$keterangan')";
