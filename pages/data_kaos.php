                                ...
                                <form class="needs-validation" action="proses/pros_edit_kaos.php" method="post">
                                  <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <label for="contry">ukuran</label><br>
                                        <select class="custom-select-d-blok w-100" name="ukuran" id="country" required="" ">
                                            <option value="" style="background-color: white;">pilih...</option>
                                            <option style="background-color: white;">XXXL</option>
                                            <option style="background-color: white;">XXL</option>
                                            <option style="background-color: white;">XL</option>
                                            <option style="background-color: white;">L</option>
                                            <option style="background-color: white;">M</option>
                                            <option style="background-color: white;">S</option>
                                        </select>
                                        <div class ="invalid-feedback">
